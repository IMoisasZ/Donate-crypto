...
contract DonateCrypto {
    ...
    function donate (uint256 id) public payable {
        ...
        require(campaigns[id].active == true, "Can not donate to this campaing");
    ...
    function withdraw(uint256 id) public {
        ...
        require(campaign.balance > fee, "Ths campaign does not have enough balance");
